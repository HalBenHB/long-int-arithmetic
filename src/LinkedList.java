...
public class LinkedList {
    ...
    public LinkedList(LinkedList linkedList) {
        ...
        head = new Node(linkedList.head.getData());
        tail = new Node(linkedList.tail.getData());

        Node tmpNode=linkedList.head;
        Node tmpNodeCurrent=head;

        while(tmpNode!=linkedList.tail){
            tmpNode=tmpNode.getNext();
            tmpNodeCurrent.setNext(new Node(tmpNode.getData()));
            tmpNodeCurrent=tmpNodeCurrent.getNext();
        }
    }
